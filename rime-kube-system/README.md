...
| https://helm.ngc.nvidia.com/nvidia | nvidia-gpu-operator(gpu-operator) | v24.6.2 |
...
| oci://ghcr.io/kserve/charts | kserve | v0.12.0 |
| oci://ghcr.io/kserve/charts | kserve-crd | v0.12.0 |
...
| nvidia-gpu-operator | object | (see individual values in `values`.yaml) | For full reference, see https://github.com/NVIDIA/gpu-operator/tree/v24.6.2 |
...
| rimeSystem.nvidiaGpuOperator | bool | `false` | Whether to install the Nvidia GPU Operator Helm chart. For full reference, see https://github.com/NVIDIA/gpu-operator/tree/main |
