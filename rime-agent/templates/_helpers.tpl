...
access to read S3 buckets.
*/}}
{{- define "rime-agent.generativeModelTestingRPCJob.serviceAccountName" -}}
{{- if .Values.rimeAgent.operator.modelTestJob.serviceAccount.create -}}
    {{ default "rime-agent-generative-model-tester" .Values.rimeAgent.operator.generativeModelTestingRPCJob.serviceAccount.name }}
{{- else -}}
    {{ default "default" .Values.rimeAgent.operator.generativeModelTestingRPCJob.serviceAccount.name }}
{{- end -}}
{{- end -}}
