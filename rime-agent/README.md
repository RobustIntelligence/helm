...
| rimeAgent.detectionServer.deployment.serverResources.limits.memory | string | `"2300Mi"` |  |
| rimeAgent.detectionServer.deployment.serverResources.requests.cpu | string | `"250m"` |  |
| rimeAgent.detectionServer.deployment.serverResources.requests.memory | string | `"2300Mi"` |  |
