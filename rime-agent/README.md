...
|-----|------|---------|-------------|
| ri-detection-resources | object | `{"enabled":false,"modelServers":{"factualInconsistency":{"enabled":false},"factualInconsistencyJa":{"enabled":false},"languageDetection":{"enabled":false},"promptInjectionBinary":{"enabled":false},"promptInjectionMulticlass":{"enabled":false},"textEmbedding":{"enabled":false},"textEmbeddingJa":{"enabled":false},"toxicityInterpretability":{"enabled":false}}}` | RI detection resources like model servers and YARA servers. These are used for GAI model testing. |
...
| rimeAgent.agentDeploymentLauncher.deployment.securityContext.fsGroup | int | `1000` |  |
| rimeAgent.agentDeploymentLauncher.deployment.securityContext.runAsGroup | int | `1000` |  |
| rimeAgent.agentDeploymentLauncher.deployment.securityContext.runAsUser | int | `1000` |  |
| rimeAgent.agentDeploymentLauncher.deployment.tolerations[0].effect | string | `"NoSchedule"` |  |
| rimeAgent.agentDeploymentLauncher.deployment.tolerations[0].key | string | `"dedicated"` |  |
| rimeAgent.agentDeploymentLauncher.deployment.tolerations[0].operator | string | `"Equal"` |  |
| rimeAgent.agentDeploymentLauncher.deployment.tolerations[0].value | string | `"dps"` |  |
...
| rimeAgent.agentDeploymentOperator.deployment.securityContext.fsGroup | int | `1000` |  |
| rimeAgent.agentDeploymentOperator.deployment.securityContext.runAsGroup | int | `1000` |  |
| rimeAgent.agentDeploymentOperator.deployment.securityContext.runAsUser | int | `1000` |  |
| rimeAgent.agentDeploymentOperator.deployment.tolerations[0].effect | string | `"NoSchedule"` |  |
| rimeAgent.agentDeploymentOperator.deployment.tolerations[0].key | string | `"dedicated"` |  |
| rimeAgent.agentDeploymentOperator.deployment.tolerations[0].operator | string | `"Equal"` |  |
| rimeAgent.agentDeploymentOperator.deployment.tolerations[0].value | string | `"dps"` |  |
...
| rimeAgent.agentDeploymentOperator.serviceAccount.labels | object | `{}` | Specify ARN of IRSA-enabled Operator IAM role here.  This is required if you enable log archival. eks.amazonaws.com/role-arn: "" |
...
| rimeAgent.detectionServer.deployment.securityContext.fsGroup | int | `1000` |  |
| rimeAgent.detectionServer.deployment.securityContext.runAsGroup | int | `1000` |  |
| rimeAgent.detectionServer.deployment.securityContext.runAsUser | int | `1000` |  |
| rimeAgent.detectionServer.deployment.serverResources.limits.memory | string | `"3500Mi"` |  |
| rimeAgent.detectionServer.deployment.serverResources.requests.cpu | string | `"250m"` |  |
| rimeAgent.detectionServer.deployment.serverResources.requests.memory | string | `"3500Mi"` |  |
| rimeAgent.detectionServer.deployment.tolerations[0].effect | string | `"NoSchedule"` |  |
| rimeAgent.detectionServer.deployment.tolerations[0].key | string | `"dedicated"` |  |
| rimeAgent.detectionServer.deployment.tolerations[0].operator | string | `"Equal"` |  |
| rimeAgent.detectionServer.deployment.tolerations[0].value | string | `"dps"` |  |
...
| rimeAgent.fileServer.deployment.securityContext.fsGroup | int | `1000` |  |
| rimeAgent.fileServer.deployment.securityContext.runAsGroup | int | `1000` |  |
| rimeAgent.fileServer.deployment.securityContext.runAsUser | int | `1000` |  |
| rimeAgent.fileServer.deployment.tolerations[0].effect | string | `"NoSchedule"` |  |
| rimeAgent.fileServer.deployment.tolerations[0].key | string | `"dedicated"` |  |
| rimeAgent.fileServer.deployment.tolerations[0].operator | string | `"Equal"` |  |
| rimeAgent.fileServer.deployment.tolerations[0].value | string | `"dps"` |  |
...
| rimeAgent.operator.serviceAccount.labels | object | `{}` | Specify ARN of IRSA-enabled Operator IAM role here.  This is required if you enable log archival. eks.amazonaws.com/role-arn: "" |
