...
| riFirewall.enableHybridDeployment | bool | `false` |  |
| riFirewall.enableNewModernBert | bool | `true` |  |
| riFirewall.enableTritonInference | bool | `false` |  |
...
| riFirewall.lifecyclePreStop.enabled | bool | `true` |  |
| riFirewall.lifecyclePreStop.sleepSeconds | int | `30` |  |
...
| riFirewall.modelServers.promptInjectionToxicity.remoteModelServerAddress | string | `""` |  |
| riFirewall.modelServers.promptInjectionToxicity.resources.limits.cpu | string | `"5000m"` |  |
| riFirewall.modelServers.promptInjectionToxicity.resources.limits.gpu | int | `0` |  |
| riFirewall.modelServers.promptInjectionToxicity.resources.limits.memory | string | `"3500Mi"` |  |
| riFirewall.modelServers.promptInjectionToxicity.resources.max_replicas | int | `3` |  |
| riFirewall.modelServers.promptInjectionToxicity.resources.min_replicas | int | `1` |  |
| riFirewall.modelServers.promptInjectionToxicity.resources.requests.cpu | string | `"1000m"` |  |
| riFirewall.modelServers.promptInjectionToxicity.resources.requests.gpu | int | `0` |  |
| riFirewall.modelServers.promptInjectionToxicity.resources.requests.memory | string | `"3500Mi"` |  |
| riFirewall.modelServers.promptInjectionToxicity.useCachedArtifact.dockerImageOverride.name | string | `"robustintelligencehq/firewall-model-server-prompt-injection-toxicity:latest"` |  |
| riFirewall.modelServers.promptInjectionToxicity.useCachedArtifact.dockerImageOverride.registry | string | `"docker.io"` |  |
| riFirewall.modelServers.promptInjectionToxicity.useCachedArtifact.enabled | bool | `false` |  |
...
| riFirewall.modelServers.tritonPromptInjectionBinary.remoteModelServerAddress | string | `""` |  |
| riFirewall.modelServers.tritonPromptInjectionBinary.resources.limits.cpu | string | `"5000m"` |  |
| riFirewall.modelServers.tritonPromptInjectionBinary.resources.limits.gpu | int | `0` |  |
| riFirewall.modelServers.tritonPromptInjectionBinary.resources.limits.memory | string | `"6000Mi"` |  |
| riFirewall.modelServers.tritonPromptInjectionBinary.resources.max_replicas | int | `1` |  |
| riFirewall.modelServers.tritonPromptInjectionBinary.resources.min_replicas | int | `1` |  |
| riFirewall.modelServers.tritonPromptInjectionBinary.resources.requests.cpu | string | `"1000m"` |  |
| riFirewall.modelServers.tritonPromptInjectionBinary.resources.requests.gpu | int | `0` |  |
| riFirewall.modelServers.tritonPromptInjectionBinary.resources.requests.memory | string | `"6000Mi"` |  |
| riFirewall.modelServers.tritonPromptInjectionBinary.useCachedArtifact.dockerImageOverride.name | string | `"robustintelligencehq/triton-inference-server:prompt-injection-trt-25.05-gpu-optimized-512-tokens-2-model-rep-v2"` |  |
| riFirewall.modelServers.tritonPromptInjectionBinary.useCachedArtifact.dockerImageOverride.registry | string | `"docker.io"` |  |
| riFirewall.modelServers.tritonPromptInjectionBinary.useCachedArtifact.enabled | bool | `false` |  |
| riFirewall.modelServers.tritonToxicityIntentMultiLabels.remoteModelServerAddress | string | `""` |  |
| riFirewall.modelServers.tritonToxicityIntentMultiLabels.resources.limits.cpu | string | `"5000m"` |  |
| riFirewall.modelServers.tritonToxicityIntentMultiLabels.resources.limits.gpu | int | `0` |  |
| riFirewall.modelServers.tritonToxicityIntentMultiLabels.resources.limits.memory | string | `"6000Mi"` |  |
| riFirewall.modelServers.tritonToxicityIntentMultiLabels.resources.max_replicas | int | `1` |  |
| riFirewall.modelServers.tritonToxicityIntentMultiLabels.resources.min_replicas | int | `1` |  |
| riFirewall.modelServers.tritonToxicityIntentMultiLabels.resources.requests.cpu | string | `"1000m"` |  |
| riFirewall.modelServers.tritonToxicityIntentMultiLabels.resources.requests.gpu | int | `0` |  |
| riFirewall.modelServers.tritonToxicityIntentMultiLabels.resources.requests.memory | string | `"6000Mi"` |  |
| riFirewall.modelServers.tritonToxicityIntentMultiLabels.useCachedArtifact.dockerImageOverride.name | string | `"robustintelligencehq/triton-inference-server:toxicity-detection-trt-25.05-gpu-1-model-rep-v4"` |  |
| riFirewall.modelServers.tritonToxicityIntentMultiLabels.useCachedArtifact.dockerImageOverride.registry | string | `"docker.io"` |  |
| riFirewall.modelServers.tritonToxicityIntentMultiLabels.useCachedArtifact.enabled | bool | `false` |  |
...
| riFirewall.terminationGracePeriodSeconds | object | `{"enabled":true,"seconds":120}` | Configuration for graceful shutdown of firewall instances |
