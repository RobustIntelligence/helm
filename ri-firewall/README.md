...
| riFirewall.modelServers.promptInjectionToxicityIntentMultiLabel.remoteModelServerAddress | string | `""` |  |
| riFirewall.modelServers.promptInjectionToxicityIntentMultiLabel.resources.limits.cpu | string | `"5000m"` |  |
| riFirewall.modelServers.promptInjectionToxicityIntentMultiLabel.resources.limits.gpu | int | `0` |  |
| riFirewall.modelServers.promptInjectionToxicityIntentMultiLabel.resources.limits.memory | string | `"3500Mi"` |  |
| riFirewall.modelServers.promptInjectionToxicityIntentMultiLabel.resources.max_replicas | int | `3` |  |
| riFirewall.modelServers.promptInjectionToxicityIntentMultiLabel.resources.min_replicas | int | `1` |  |
| riFirewall.modelServers.promptInjectionToxicityIntentMultiLabel.resources.requests.cpu | string | `"1000m"` |  |
| riFirewall.modelServers.promptInjectionToxicityIntentMultiLabel.resources.requests.gpu | int | `0` |  |
| riFirewall.modelServers.promptInjectionToxicityIntentMultiLabel.resources.requests.memory | string | `"3500Mi"` |  |
| riFirewall.modelServers.promptInjectionToxicityIntentMultiLabel.useCachedArtifact.dockerImageOverride.name | string | `"robustintelligencehq/firewall-model-server-prompt-injection-toxicity-intent-multi-label:latest"` |  |
| riFirewall.modelServers.promptInjectionToxicityIntentMultiLabel.useCachedArtifact.dockerImageOverride.registry | string | `"docker.io"` |  |
| riFirewall.modelServers.promptInjectionToxicityIntentMultiLabel.useCachedArtifact.enabled | bool | `false` |  |
