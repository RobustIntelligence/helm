...
| riFirewall.modelServers.tritonPromptInjectionBinary.resources.limits.gpu | int | `1` |  |
...
| riFirewall.modelServers.tritonPromptInjectionBinary.resources.requests.gpu | int | `1` |  |
...
| riFirewall.modelServers.tritonToxicityIntentMultiLabels.resources.limits.gpu | int | `1` |  |
...
| riFirewall.modelServers.tritonToxicityIntentMultiLabels.resources.requests.gpu | int | `1` |  |
