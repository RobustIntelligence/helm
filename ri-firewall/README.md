...
| riFirewall.modelServers.promptInjectionBinary.resources.limits.gpu | int | `2` |  |
...
| riFirewall.modelServers.promptInjectionBinary.resources.requests.gpu | int | `2` |  |
...
| riFirewall.modelServers.toxicity.resources.limits.gpu | int | `2` |  |
...
| riFirewall.modelServers.toxicity.resources.requests.gpu | int | `2` |  |
...
| riFirewall.modelServers.toxicityIntentMultiLabel.resources.limits.gpu | int | `2` |  |
...
| riFirewall.modelServers.toxicityIntentMultiLabel.resources.requests.gpu | int | `2` |  |
...
| riFirewall.modelServers.toxicityInterpretability.resources.limits.gpu | int | `2` |  |
...
| riFirewall.modelServers.toxicityInterpretability.resources.requests.gpu | int | `2` |  |
...
| riFirewall.modelServers.toxicityJa.resources.limits.gpu | int | `2` |  |
...
| riFirewall.modelServers.toxicityJa.resources.requests.gpu | int | `2` |  |
...
| riFirewall.modelServers.xlmMultilingualHarmful.resources.limits.gpu | int | `2` |  |
...
| riFirewall.modelServers.xlmMultilingualHarmful.resources.requests.gpu | int | `2` |  |
...
| riFirewall.modelServers.xlmMultilingualToxicity.resources.limits.gpu | int | `2` |  |
...
| riFirewall.modelServers.xlmMultilingualToxicity.resources.requests.gpu | int | `2` |  |
