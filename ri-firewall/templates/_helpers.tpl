...
{{/*
Return the service account name used by the YARA operator.
*/}}
{{- define "ri-firewall.yaraOperator.serviceAccountName" -}}
{{- if .Values.riFirewall.yaraOperator.serviceAccount.create -}}
    {{ default (printf "%s-%s" (include "ri-firewall.fullname" .) .Values.riFirewall.yaraOperator.name) .Values.riFirewall.yaraOperator.serviceAccount.name | trunc 63 | trimSuffix "-" }}
{{- else -}}
    {{ default "default" .Values.riFirewall.yaraOperator.serviceAccount.name }}
{{- end -}}
{{- end -}}
