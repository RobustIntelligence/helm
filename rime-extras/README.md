...
| prometheus.server.global.scrape_interval | string | `"60s"` |  |
...
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].honor_labels | bool | `true` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].job_name | string | `"kubernetes-pods"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].kubernetes_sd_configs[0].role | string | `"pod"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].metric_relabel_configs[0].regex | string | `"go_.*"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].metric_relabel_configs[0].replacement | string | `"true"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].metric_relabel_configs[0].source_labels[0] | string | `"__name__"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].metric_relabel_configs[0].target_label | string | `"drop"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].metric_relabel_configs[1].regex | string | `"go_goroutines|go_gc_duration_seconds|go_memstats_heap_alloc_bytes"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].metric_relabel_configs[1].replacement | string | `"false"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].metric_relabel_configs[1].source_labels[0] | string | `"__name__"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].metric_relabel_configs[1].target_label | string | `"drop"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].metric_relabel_configs[2].regex | string | `"node_.*"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].metric_relabel_configs[2].replacement | string | `"true"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].metric_relabel_configs[2].source_labels[0] | string | `"__name__"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].metric_relabel_configs[2].target_label | string | `"drop"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].metric_relabel_configs[3].regex | string | `"node_memory_MemTotal_bytes|node_memory_MemAvailable_bytes|node_cpu_seconds_total"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].metric_relabel_configs[3].replacement | string | `"false"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].metric_relabel_configs[3].source_labels[0] | string | `"__name__"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].metric_relabel_configs[3].target_label | string | `"drop"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].metric_relabel_configs[4].action | string | `"drop"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].metric_relabel_configs[4].regex | string | `"true"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].metric_relabel_configs[4].source_labels[0] | string | `"drop"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[0].action | string | `"keep"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[0].regex | bool | `true` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[0].source_labels[0] | string | `"__meta_kubernetes_pod_annotation_prometheus_io_scrape"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[10].action | string | `"drop"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[10].regex | string | `"Pending|Succeeded|Failed|Completed"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[10].source_labels[0] | string | `"__meta_kubernetes_pod_phase"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[11].action | string | `"replace"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[11].source_labels[0] | string | `"__meta_kubernetes_pod_node_name"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[11].target_label | string | `"node"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[1].action | string | `"keep"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[1].regex | string | `"ri"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[1].source_labels[0] | string | `"__meta_kubernetes_pod_annotation_app_kubernetes_io_owned_by"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[2].action | string | `"replace"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[2].regex | string | `"(https?)"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[2].source_labels[0] | string | `"__meta_kubernetes_pod_annotation_prometheus_io_scheme"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[2].target_label | string | `"__scheme__"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[3].action | string | `"replace"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[3].regex | string | `"(.+)"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[3].source_labels[0] | string | `"__meta_kubernetes_pod_annotation_prometheus_io_path"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[3].target_label | string | `"__metrics_path__"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[4].action | string | `"replace"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[4].regex | string | `"(\\d+);(([A-Fa-f0-9]{1,4}::?){1,7}[A-Fa-f0-9]{1,4})"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[4].replacement | string | `"[$2]:$1"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[4].source_labels[0] | string | `"__meta_kubernetes_pod_annotation_prometheus_io_port"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[4].source_labels[1] | string | `"__meta_kubernetes_pod_ip"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[4].target_label | string | `"__address__"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[5].action | string | `"replace"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[5].regex | string | `"(\\d+);((([0-9]+?)(\\.|$)){4})"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[5].replacement | string | `"$2:$1"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[5].source_labels[0] | string | `"__meta_kubernetes_pod_annotation_prometheus_io_port"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[5].source_labels[1] | string | `"__meta_kubernetes_pod_ip"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[5].target_label | string | `"__address__"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[6].action | string | `"labelmap"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[6].regex | string | `"__meta_kubernetes_pod_annotation_prometheus_io_param_(.+)"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[6].replacement | string | `"__param_$1"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[7].action | string | `"labelmap"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[7].regex | string | `"__meta_kubernetes_pod_label_(.+)"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[8].action | string | `"replace"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[8].source_labels[0] | string | `"__meta_kubernetes_namespace"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[8].target_label | string | `"namespace"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[9].action | string | `"replace"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[9].source_labels[0] | string | `"__meta_kubernetes_pod_name"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[0].relabel_configs[9].target_label | string | `"pod"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[1].honor_labels | bool | `true` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[1].job_name | string | `"aws-node"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[1].kubernetes_sd_configs[0].role | string | `"pod"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[1].relabel_configs[0].action | string | `"keep"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[1].relabel_configs[0].regex | string | `"aws-vpc-cni"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[1].relabel_configs[0].source_labels[0] | string | `"__meta_kubernetes_pod_label_app_kubernetes_io_instance"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[1].relabel_configs[1].action | string | `"keep"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[1].relabel_configs[1].regex | bool | `true` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[1].relabel_configs[1].source_labels[0] | string | `"__meta_kubernetes_pod_annotation_prometheus_io_scrape"` |  |
...
| rimeExtras.logscaleFluentBit | bool | `false` | Whether to install the Logscale(previously know as humio) FluentBit Helm charts for sending Firewall validation logs to Logscale(Crowdstrike) for SIEM |
