...
| prometheus.server.remoteWrite[0].url | string | `"https://aps-workspaces.us-west-2.amazonaws.com/workspaces/ws-7fb56177-3059-4d66-82ad-ddcbe88246a1/api/v1/remote_write"` |  |
