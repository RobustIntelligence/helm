...
sub_rime_uninstall() {
  ...
  kubectl get secret | grep tls | awk '{print $1}' | xargs -I {} kubectl delete secret {}
}
...
sub_help() {
  ...
  echo "    clean:       Delete all pvcs and tls cert secrets in a namespace to clean specified namespace."
