...
gen_operator_manifests: gen_rime_agent_crds gen_rime_agent_deployment_crds gen_ri_firewall_crds gen_yara_crds $(RIME_AGENT_OPERATOR_ROLE_FILE) $(RIME_AGENT_DEPLOYMENT_OPERATOR_ROLE_FILE) $(RI_FIREWALL_OPERATOR_ROLE_FILE)
