...
| rime.cacheServer.existingConfigSecretName | string | `""` | Use if MANUALLY creating a Secret to replace the default internal service configuration. NOTE: This Secret's schema MUST match that of the corresponding default defined in /templates/**/configmap.yaml. |
...
| rime.scheduledSTCron | object | `{"annotations":{},"enabled":false,"labels":{},"name":"scheduled-st-cron","schedule":"*/20 * * * *"}` | Configuration for Scheduled Stress Testing |
